...
export interface paths {
    ...
    "/api/v1/engine/health": {
        ...
        /**
         * Get Engine Health
         * @description Returns the live health status of the core 'All-in-One' Engine components:
         *     Real-Debrid (Streaming cache) and Decypharr (Cloudflare bypass).
         */
        get: operations["get_engine_health_api_v1_engine_health_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/engine/seerr_webhook": {
        ...
        put?: never;
        /**
         * Process Seerr Webhook
         * @description Receives JSON webhooks directly from a standalone Seerr instance.
         ...
         */
        post: operations["process_seerr_webhook_api_v1_engine_seerr_webhook_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/engine/webhooks": {
        ...
        /**
         * Get Webhook Logs
         * @description Returns the most recent Seerr webhook requests for the Admin Control Panel.
         */
        get: operations["get_webhook_logs_api_v1_engine_webhooks_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/engine/transfers": {
         ...
         * @description Returns the live caching progress on the Real-Debrid network.
         */
        get: operations["get_active_transfers_api_v1_engine_transfers_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/engine/torrents": {
        ...
        /**
         * Get All Torrents
         * @description Returns the entire Real-Debrid cache history.
         */
        get: operations["get_all_torrents_api_v1_engine_torrents_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/engine/torrents/{torrent_id}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /**
         * Delete Torrent
         * @description Deletes a specific torrent cache from the Real-Debrid network.
         */
        delete: operations["delete_torrent_api_v1_engine_torrents__torrent_id__delete"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
    };
    "/api/v1/engine/seerr/requests": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /**
         * Get Seerr Requests
         * @description Actively fetches the request queue from the standalone Seerr instance.
         */
        get: operations["get_seerr_requests_api_v1_engine_seerr_requests_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/engine/settings": {
        ...
        /**
         * Get Engine Settings
         * @description Returns the current configurations for the Engine.
         */
        get: operations["get_engine_settings_api_v1_engine_settings_get"];
        put?: never;
        /**
         * Update Engine Settings
         * @description Updates the physical TOML configuration file with the new settings.
         */
        post: operations["update_engine_settings_api_v1_engine_settings_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        ...
        /** EngineSettings */
        EngineSettings: {
            real_debrid: components["schemas"]["RealDebridSettings"];
            decypharr: components["schemas"]["DecypharrSettings"];
            seerr: components["schemas"]["SeerrSettings"];
        };
        /** Episode */
        Episode: {
            /**
...
export interface operations {
    ...
    get_engine_health_api_v1_engine_health_get: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    process_seerr_webhook_api_v1_engine_seerr_webhook_post: {
        parameters: {
            query?: {
                metadata_provider?: "tmdb" | "tvdb";
            };
    ...
    get_webhook_logs_api_v1_engine_webhooks_get: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    get_active_transfers_api_v1_engine_transfers_get: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    get_all_torrents_api_v1_engine_torrents_get: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    delete_torrent_api_v1_engine_torrents__torrent_id__delete: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    get_seerr_requests_api_v1_engine_seerr_requests_get: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    get_engine_settings_api_v1_engine_settings_get: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    update_engine_settings_api_v1_engine_settings_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
